(() => {
    ...
    modal.querySelectorAll('[data-close-address]').forEach((button) => button.addEventListener('click', () => modal.close()));
    ...
    checkout.addEventListener('submit', (event) => {
        ...
        if (checkout.dataset.submitted === 'true') return event.preventDefault();
    ...
    addressForm.addEventListener('submit', (event) => {
        ...
        if (saveButton.disabled) return event.preventDefault();
