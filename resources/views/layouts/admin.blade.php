<!DOCTYPE html>
<html lang="en" data-admin-theme-key="achilles.admin.theme.{{ auth()->id() }}">
<head>
    <meta charset="UTF-8">
...
@endif
        ...
        <a href="{{ route('admin.settings.index') }}" data-tooltip="Settings" class="{{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
