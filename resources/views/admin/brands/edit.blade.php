...
<div class="max-w-2xl mx-auto py-10 relative z-10">
    <div class="card-3d rounded-2xl p-6 md:p-8">
        ...
        <!-- Back Link -->
        <a href="{{ request('return_to', route('admin.brands.index')) }}" class="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-red-600 transition-all mb-6 hover:translate-x-[-2px]">
