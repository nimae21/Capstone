...
@forelse($products as $product)
    <li>
        <strong>{{ $product->product_name }}</strong> - {{ $product->product_description ?? 'No description' }}
        ...
        <div style="margin-top:10px; border:1px solid #ccc; padding:10px;">
            ...
            <!-- Add Variant Form -->
            <form action="{{ route('admin.products.variants.store', $product->product_id) }}" method="POST" style="margin-bottom:10px;">
                @csrf
