...
<div class="container" style="padding-top: 2rem; padding-bottom: 3rem;">
    ...
    <div class="pagination">
        @if ($products->onFirstPage())
            <span class="page-link disabled" style="opacity: 0.5;">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
            </span>
        @else
            <a href="{{ $products->previousPageUrl() }}" class="page-link" rel="prev">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
            </a>
        ...
        @if ($products->hasMorePages())
            <a href="{{ $products->nextPageUrl() }}" class="page-link" rel="next">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function applySort(value) {
    ...
    // Preserve pagination page when sorting
    url.searchParams.delete('page');
    
    window.location.href = url.toString();
}

// Preserve sort when clicking pagination
